...
const Navbar = () => {
  return (
    <div className='bg-blue-900 flex justify-between px-3 py-5 h-16'>
      <span className='text-white text-xl font-bold tracking-wider'>CC Chat</span>
      <div className='flex items-center space-x-2'>
        ...
        <span className='text-white text-sm'>John Norton</span>
        <button className='text-white bg-sky-600 hover:bg-sky-500 transition-all px-2 py-1 rounded-lg'>Logout</button>
      </div>
    </div>
  )
}
